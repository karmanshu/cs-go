...
const TestCard = ({ test, onStart }) => {
  return (
    <div className="bg-white dark:bg-gray-800 overflow-hidden shadow rounded-lg border border-gray-200 dark:border-gray-700 transition-all hover:shadow-md hover:border-blue-300 dark:hover:border-blue-500 flex flex-col h-full">
      <div className="px-4 py-5 sm:p-6 flex-grow">
        ...
        <div className="mt-2 flex flex-col space-y-2 text-sm text-gray-500 dark:text-gray-400">
          <div className="flex items-center">
            <HelpCircle className="flex-shrink-0 mr-1.5 h-4 w-4 text-gray-400 dark:text-gray-500" />
      ...
      <div className="bg-gray-50 dark:bg-gray-700/50 px-4 py-4 sm:px-6 mt-auto">
        <button
