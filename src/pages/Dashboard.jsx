      ...
      <main className="flex-grow">
        <div className="max-w-7xl mx-auto py-10 sm:px-6 lg:px-8">
          ...
          <div className="px-4 pb-8 sm:px-0">
            <h1 className="text-3xl font-bold font-sans text-gray-900 mb-2">Welcome, {user?.username}</h1>
            <p className="text-gray-600">Select a mock test below to check your preparation level.</p>
          </div>
          ...
          <div className="px-4 sm:px-0">
            {activeTest && (
              <div className="mb-8 bg-blue-50 border border-blue-200 rounded-lg p-4 flex items-center justify-between">
                <div>
                  <h3 className="text-lg font-medium text-blue-900">Test in progress</h3>
                  <p className="text-blue-700">You have an ongoing test. Don't lose your progress!</p>
                </div>
                <button
      ...
      {showResumeModal && (
        <div className="fixed inset-0 z-50 flex items-center justify-center bg-black bg-opacity-50 backdrop-blur-sm transition-opacity duration-300">
          <div className="bg-white rounded-xl shadow-2xl p-8 max-w-md w-full transform transition-all scale-100 opacity-100">
            ...
            <h3 className="text-2xl font-bold text-center text-gray-900 mb-2">Resume Test?</h3>
